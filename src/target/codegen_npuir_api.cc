...
void CodeGenTileLangNPUIR::VcosCodegen(const CallNode *op) {
...
///   - store the final result into destination vector
///   - all intermediate results are lowered to vector operations on memref subviews
void CodeGenTileLangNPUIR::VsinCodegen(const CallNode *op) {
...
///   - store the final result into destination vector
///   - all intermediate results are lowered to vector operations on memref subviews
void CodeGenTileLangNPUIR::VerfCodegen(const CallNode *op) {
...
///   - store the final result into destination vector
///   - all intermediate results are lowered to vector operations on memref subviews
void CodeGenTileLangNPUIR::VtanhCodegen(const CallNode *op) {
